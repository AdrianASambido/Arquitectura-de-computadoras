...
org 1000h
	...
	reemplazo db "o"
org 3000h
	contar_char: mov bx,sp ;en bx vamos a usar el sp para movemos en la pila
	add bx,2 ;ubicamos operando, incrementando el sp
	mov al,[bx] ;manda el caracter a reemplazar
	add bx,2 ;ubicamos el operando incrementando el sp
